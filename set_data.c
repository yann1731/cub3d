...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/17 15:58:34 by tgarriss          #+#    #+#             */
/*   Updated: 2022/12/17 16:15:51 by tgarriss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "includes/cub3d.h"

//To get the 2D vector perpendicular to another
//2D vector simply swap the X and Y components, negating the new Y component.
// So { x, y } becomes { y, -x } .
